...
\includegraphics{2020-01-15-brynmawr_files/figure-latex/factor-plot-default-order-2.pdf}
...
\includegraphics{2020-01-15-brynmawr_files/figure-latex/factor-plot-reorder-2.pdf}
...
\includegraphics{2020-01-15-brynmawr_files/figure-latex/unnamed-chunk-100-1.pdf}
...
\KeywordTok{ggplot}\NormalTok{(interviews) }\OperatorTok{+}\StringTok{ }\KeywordTok{geom_bar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(has_bicycle))}
\end{Highlighting}
\end{Shaded}

\includegraphics{2020-01-15-brynmawr_files/figure-latex/unnamed-chunk-102-1.pdf}
...
\begin{Highlighting}[]
\NormalTok{interviews <-}\StringTok{ }\NormalTok{interviews }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{months_lack_food =} \KeywordTok{str_replace_all}\NormalTok{(months_lack_food, }\StringTok{"Jan"}\NormalTok{, }\StringTok{"January"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{## 1.}
\NormalTok{interviews <-}\StringTok{ }\NormalTok{interviews }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{brick =} \KeywordTok{str_detect}\NormalTok{(respondent_wall_type, }\StringTok{"brick"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
\end{quote}
\end{quote}
...
\begin{Highlighting}[]
\NormalTok{interviews <-}\StringTok{ }\NormalTok{interviews }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{day =} \KeywordTok{day}\NormalTok{(dates),}
         \DataTypeTok{month =} \KeywordTok{month}\NormalTok{(dates),}
         \KeywordTok{year}\NormalTok{(dates))}
\KeywordTok{str}\NormalTok{(interviews)}
\end{Highlighting}
\end{Shaded}
...
\begin{flushleft}\includegraphics{2020-01-15-brynmawr_files/figure-latex/rmd_to_html_fig-1} \end{flushleft}
